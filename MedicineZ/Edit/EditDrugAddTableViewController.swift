//
//  EditDrugAddTableViewController.swift
//  MedicineZ
//
...
import UIKit
protocol EditAlarmInfoProtocol {
    func addDrugList(drugItem: [String:String])
}

class EditDrugAddTableViewController: UITableViewController, UISearchBarDelegate, XMLParserDelegate {

    var delegate:EditAlarmInfoProtocol?
